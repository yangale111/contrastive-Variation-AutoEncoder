...
fake_dir = './Dataset/fake_data_CN_MCI/'
...
while k < 5:
    ...
    fake_background_data, fake_target_data = create_fake_dataset(z_encoder, s_encoder, MCI_train_data, batch_size, k)

    create_tfrecord(CN_train_data, MCI_train_data, fake_background_data, fake_target_data, fake_dir+'train_{}/'.format(k) + 'aug_train.tfrecord')
    create_tfrecord(CN_train_data, MCI_train_data,[],[], fake_dir+'train_{}/'.format(k) + 'ori_train.tfrecord')
    create_tfrecord(CN_test_data, MCI_test_data, [],[], fake_dir+'train_{}/'.format(k) + 'test.tfrecord')
